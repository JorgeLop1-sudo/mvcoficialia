...
<body>
    ...
    <div class="sidebar">
        ...
        <ul class="nav flex-column">
            ...
            <li class="nav-item">
                <a class="nav-link active" href="index.php?action=expedientesadmin">
        ...
        <div class="search-section">
            ...
            <form method="GET" action="">
                ...
                <div class="search-actions">
                    <a href="index.php?action=expedientesadmin" class="btn btn-secondary">Limpiar</a>
    ...
    <script>
        ...
        function confirmarEliminacion(id) {
            if (confirm('¿Está seguro de eliminar este oficio? Esta acción no se puede deshacer.')) {
                window.location.href = 'index.php?action=expedientesadmin&eliminar=' + id;
            }
        }
        ...
        function cargarUsuariosPorArea(areaId) {
            ...
            $.ajax({
                url: 'index.php?action=expedientesadmin&ajax=usuarios_por_area&area_id=' + areaId,
                type: 'GET',
                dataType: 'json',
